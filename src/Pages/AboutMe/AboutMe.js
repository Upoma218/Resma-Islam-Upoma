    ...
    return (
        <div className='p-20 bg-base-200'>
            ...
            <div className='grid grid-cols-2 lg:grid-cols-6 md:grid-cols-3 gap-3 rounded lg:px-32 md:px-32'>
                <img src={LogoHtml} alt="" className='w-32 h-32 bg-neutral p-6 rounded' />
                <img src={LogoReact} alt="" className='w-32 h-32 bg-neutral p-6 rounded' />
                <img src={LogoCss} alt="" className='w-32 h-32 bg-neutral p-6 rounded' />
                <img src={LogoBootstrap} alt="" className='w-32 h-32 bg-neutral p-6 rounded' />
                <img src={LogoGitHub} alt="" className='w-32 h-32 bg-neutral p-6 rounded' />
                <img src={LogoJS} alt="" className='w-32 h-32 bg-neutral p-6 rounded' />
            </div>
