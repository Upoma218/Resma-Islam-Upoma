    ...
    return (
        <div className='px-20 mb-12'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-8  rounded mt-16'>
                ...
                <div className="card bg-base-100 shadow-xl image-full mb-12 lg:h-60">
                    <figure><img src={LogoReact} alt="" className='lg:h-40' /></figure>
                    <div className="card-body">
                ...
                <div className="card bg-base-100 shadow-xl image-full mb-12 lg:h-60">
                    <figure><img src={LogoCss} alt="" className='lg:h-40' /></figure>
                    <div className="card-body">
                ...
                <div className="card bg-base-100 shadow-xl image-full mb-12 lg:h-60">
                    <figure><img src={LogoGitHub} alt="" className='lg:h-40' /></figure>
                    <div className="card-body">
